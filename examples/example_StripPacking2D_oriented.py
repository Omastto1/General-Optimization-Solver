...
#     total_height, placements, orientations, solution = StripPacking2DCPSolver(TimeLimit=3).solve(problem, validate=False, visualize=False, force_execution=True)  # orientations, 
