...
def load_mmlib_solution(file_path, instance_name):
    ...
    instance_result = instances_results[instances_results["Instance"] == instance_name]
    ...
    upper_bound = max(int(instance_result["Best known makespan"]), int(instance_result["Best found makespan"]))
