...
# StripPacking2DGASolver(algorithm, fitness_func_leveled, term, seed=1, solver_name="naive GA 200_1.0").solve(benchmark, validate=True, visualize=False, force_execution=True, force_dump=False)

StripPacking2DGASolver(algorithm, fitness_func_best_fit, term, seed=1, solver_name="best fit GA 200_1.0").solve(benchmark, validate=True, visualize=False, force_execution=True, force_dump=False)
...
# StripPacking2DGASolver(algorithm, fitness_func_leveled, term, seed=1).solve(benchmark, validate=True, visualize=False, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolverOriented(TimeLimit=10, no_workers=1), force_dump=False)

# StripPacking2DGASolver(algorithm, fitness_func_leveled, ("n_gen", 20), seed=1).solve(benchmark, validate=True, visualize=False, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolverOriented(TimeLimit=10), force_dump=False)
