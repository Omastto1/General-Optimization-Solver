...
# usually 50-65
# 12 225
# StripPacking2DGASolver(algorithm, fitness_func, term, seed=1, solver_name="naive GA 200_1.0").solve(benchmark, validate=True, visualize=True, force_execution=True, force_dump=False)

# StripPacking2DCPSolver(TimeLimit=15, no_workers=1).solve(benchmark, validate=True, visualize=True, force_execution=True, force_dump=False)

StripPacking2DGASolver(algorithm, fitness_func, ("n_gen", 1), seed=1).solve(benchmark, validate=True, visualize=True, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolver(TimeLimit=10, no_workers=1), force_dump=False)

# StripPacking2DGASolver(algorithm, fitness_func, ("n_gen", 20), seed=1).solve(benchmark, validate=True, visualize=False, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolver(TimeLimit=10), force_dump=False)

# StripPacking2DCPSolverOriented(algorithm, fitness_func, term, seed=1).solve(benchmark, validate=True, visualize=False, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolver(TimeLimit=10, no_workers=1), force_dump=False)

# StripPacking2DCPSolverOriented(algorithm, fitness_func, ("n_gen", 20), seed=1).solve(benchmark, validate=True, visualize=False, force_execution=True, hybrid_CP_solver=StripPacking2DCPSolver(TimeLimit=10), force_dump=False)
